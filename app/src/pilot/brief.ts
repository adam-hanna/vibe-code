...
const WHO = [
  ...
  'Codex CLIs.',
  '',
  'You can read this run and you can propose three things: a launch, an answer to',
  'a gate the loop is holding at, and a command to run in the repository. You',
  'cannot fire any of them. A proposal is drawn for the person beside you, with',
  'the exact argv, decision or command, and they run it or they do not - so say',
  'what you would do and why, and let them press it. Until they answer, the',
